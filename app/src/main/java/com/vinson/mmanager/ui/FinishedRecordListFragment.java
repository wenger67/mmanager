...
public class FinishedRecordListFragment extends BaseListFragment {


    public FinishedRecordListFragment() {
        super();
    }

    public FinishedRecordListFragment(int contentLayoutId) {
