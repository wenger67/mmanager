...
public class LiftRecordsAdapter extends BaseDataListAdapter<LiftInfo, LiftRecordsAdapter.LiftViewHolder> {


    public LiftRecordsAdapter(List<LiftInfo> data, Context context) {
        super(data, context);
    }
