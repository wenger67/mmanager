...
public class GridMediaAdapter extends
        RecyclerView.Adapter<GridMediaAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.item_grid_media,
                viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mImg.setImageResource(R.drawable.shape_plus);
            viewHolder.mImg.setPadding(SizeUtils.dp2px(24),SizeUtils.dp2px(24),SizeUtils.dp2px(24),SizeUtils.dp2px(24));
