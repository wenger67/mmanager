...
public class LiftChangesAdapter extends BaseDataListAdapter<LiftInfo, LiftChangesAdapter.LiftViewHolder> {


    public LiftChangesAdapter(List<LiftInfo> data, Context context) {
        super(data, context);
    }
